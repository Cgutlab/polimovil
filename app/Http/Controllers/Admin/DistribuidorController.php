...
class DistribuidorController extends Controller
{
    ...
    {
        $data = Distribuidor::orderBy('order')->paginate(10);
        return view('adm.'.strtolower($this->model).'.show', ['model' => $this->model, 'data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $store = Distribuidor::create($data);
