...
use App\Http\Requests\GrammageRequest;
...
class GrammageController extends Controller
{
    ...
    public function show($master)
    {
        ...
        $section = $find->title_es;
        $data = Grammage::orderBy('order')->where('category_id', $master)->paginate(10);
