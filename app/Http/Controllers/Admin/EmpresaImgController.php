...
use App\Http\Requests\EmpresaImgRequest;
...
class EmpresaImgController extends Controller
{
    ...
    {
        $data = EmpresaImg::orderBy('order')->paginate(10);
