...
{{-- 
        <div class="input-field col s12">
          {!!Form::label('icon', trans('translator.main-icon'))!!}
          {!!Form::text('icon',$data->icon,['class'=>'validate'])!!}
        </div> --}}
        <div class="input-field col s12">
