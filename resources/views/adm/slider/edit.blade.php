...
@section('cuerpo')
  ...
  <div class="row">
      ...
      <a href="{{route('slider.show', ['section' => $section])}}" class="btn-floating btn-medium waves-effect waves-light blue right ml-3x"><i class="material-icons">keyboard_backspace</i></a>
