  ...
  {{ csrf_field() }}
  	<div class="row">
        ...
        <div class="input-field col s12">
          ...
          {!!Form::text('subtitle_es',$data->subtitle_es,['class'=>'validate'])!!}
        </div>
        <div class="input-field col s4">
          {!!Form::label('button_es', trans('translator.main-button'))!!}
          {!!Form::text('button_es',$data->button_es,['class'=>'validate'])!!}
        </div>
        <div class="input-field col s8">
          {!!Form::label('route', trans('translator.main-route'))!!}
          {!!Form::text('route',$data->route,['class'=>'validate'])!!}
        </div>
  	</div>
