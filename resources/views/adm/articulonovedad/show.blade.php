	...
	<div class="col s12">
		<table class="highlight bordered">
			...
			<tbody>
				...
				<tr>
					<td>
						@if(file_exists(public_path().'/img/novedad_articulo/'.$dat->image) && $dat->image)
							<img class="materialboxed" src="{{asset('img/novedad_articulo/'.$dat->image)}}" alt="{{$dat->title_es}}" class="responsive-img" style="max-height: 50px; max-width: 160px;">
						@else
