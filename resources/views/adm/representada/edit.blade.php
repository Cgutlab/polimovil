      ...
      <div class="file-field input-field col m8 s12">
        ...
        <div class="file-path-wrapper">
          ...
          <span style="position: absolute; padding: 7px;">
            ...
            {{-- <img src="{{asset('img/slider/'.$data->file)}}" class="materialboxed" style="height: 30px; width: 30px;"> --}}
          </span>
          @endif
          {!!Form::text('',$data->file, ['placeholder' => trans('translator.main-image-ficha'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
        </div>
      </div>
        ...
        <div class="input-field col s12">
          ...
          {!!Form::text('link', $data->link, ['class'=>'validate', 'id' => 'link'])!!}
        </div>
  	</div>
