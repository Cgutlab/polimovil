  ...
  {{ csrf_field() }}
  	<div class="row">
        ...
        <div class="input-field col m4 s12">
          ...
          {!!Form::text('orden', isset($repeat['orden']) ? $repeat['orden']: '' . old('orden'),['class'=>'validate', 'id' => 'orden'])!!}
        </div>
        <div class="file-field input-field col m8 s12">
          <div class="btn">
          ...
          <div class="file-path-wrapper">
              {!!Form::text('', isset($repeat['file']) ? $repeat['file'] : old('file'), ['placeholder' => trans('translator.main-image-ficha'), 'class'=>'file-path validate']) !!}
              @if(isset($repeat['file'])) {!!Form::text('file', isset($repeat['file']) ? $repeat['file'] : old('file'), ['class' => 'hide']) !!} @endif
          </div>
        </div>
        ...
        <div class="input-field col s12">
          {!!Form::label('link', trans('translator.main-route'))!!}
          {!!Form::text('link', isset($repeat['link']) ? $repeat['link']: '' . old('link'),['class'=>'validate', 'id' => 'link'])!!}
        </div>
