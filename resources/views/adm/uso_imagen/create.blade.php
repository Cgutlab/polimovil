  ...
  {{ csrf_field() }}
  	<div class="row">
        <div class="file-field input-field col s12 right hide">
          ...
          <label for="uso_id">@lang('translator.main-foreign')</label><br>
          <select name="uso_id" id="uso_id" class="validate">
              <option value="{{$master->id}}">#Producto: {{$master->title_es}}</option>
          </select>
        </div>
