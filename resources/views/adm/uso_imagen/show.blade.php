...
<div class="row">
	...
	<div class="col s4">
		<a href="{{ route('uso_aplicacion.index') }}" class="btn-floating btn-medium waves-effect waves-light blue right ml-3x"><i class="material-icons">keyboard_backspace</i></a>
	...
	<div class="col s12">
		<table class="highlight bordered">
			...
			<tbody>
				...
				<tr>
					<td>
						@if(file_exists(public_path().'/img/uso/'.$dat->image) && $dat->image)
							<img class="materialboxed" src="{{asset('img/uso/'.$dat->image)}}" alt="{{$dat->title_es}}" class="responsive-img" style="max-height: 50px; max-width: 160px;">
						@else
