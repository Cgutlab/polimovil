...
@section('cuerpo')
  ...
  {!!Form::model($data, ['route'=>['maquina_'.strtolower($model).'.update', $data->id], 'method'=>'PUT', 'files' => true])!!}
  {{ csrf_field() }}
  	<div class="row">
        <div class="file-field input-field col m8 s12">
          ...
          <div class="file-path-wrapper">
            ...
            @endif
            {!!Form::text('',$data->image, ['placeholder' => trans('translator.main-image-prestacion'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
          </div>
        </div>
