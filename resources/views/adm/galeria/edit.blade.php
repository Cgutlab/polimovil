...
@section('cuerpo')
  ...
  <div class="row">
    <div class="col s8">
  	...
  	<div class="col s4">
      <a href="{{ route('maq_'.strtolower($model).'.show', ['master' => $data->maquina_id]) }}" class="btn-floating btn-medium waves-effect waves-light blue right ml-3x"><i class="material-icons">keyboard_backspace</i></a>
  		<a href="{{ route('maq_'.strtolower($model).'.create', ['master' => $data->maquina_id]) }}" class="btn-floating btn-medium waves-effect waves-light green right ml-3x"><i class="material-icons">add</i></a>
  	</div>
  </div>
