...
@section('cuerpo')
  ...
  {{ csrf_field() }}
      ...
      <div class="file-field input-field col m4 s12">
        <div class="btn">
          <span>@lang('translator.main-icon')</span>
          {!! Form::file('icon') !!}
        </div>
        <div class="file-path-wrapper">
          ...
          @endif
          {!!Form::text('',$data->icon, ['placeholder' => trans('translator.main-image-icon'), 'class'=>'file-path validate', 'required', 'style' => 'padding-left: 40px;']) !!}
        </div>
      </div>
      ...
      <div class="input-field col s12">
        {!!Form::label('subtitle_es', trans('translator.main-title'))!!}
        {!!Form::text('subtitle_es', $data->subtitle_es, ['class'=>'validate', 'id' => 'subtitle_es'])!!}
      </div>
      <div class="input-field col s12">
